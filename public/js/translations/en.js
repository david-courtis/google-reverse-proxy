...
window.translations.en = {
    ...
    cannotDeleteDatabase: "Cannot delete: This account is read-only",
    ...
    connectGoogleDesc: "Connect a Google account to add it to the pool and increase your effective quota.",
