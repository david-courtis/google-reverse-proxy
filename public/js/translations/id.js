...
window.translations.id = {
    ...
    cannotDeleteDatabase: "Tidak bisa dihapus: Akun ini read-only",
    ...
    systemDesc: "OPENAI-COMPATIBLE",
    connectGoogleDesc: "Hubungkan akun Google untuk menambahkannya ke pool dan meningkatkan kuota efektif Anda.",
    ...
    pageTitle: "Google Reverse Proxy",
    live: "Live",
    tier: "Tier",
    quota: "Kuota",
    tierUltra: "Ultra",
